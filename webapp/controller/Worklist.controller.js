sap.ui.define([
		...
		return BaseController.extend("fts.cockpit.controller.Worklist", {
			...
			*/
			 ...
			 * opens detail popup from component to show PSS data.
			 * @public
			 */
			...
			// create dialog lazily
				if (!this._oPopover) {
					...
					"fts.cockpit.view.PSSPopover", this);
				}
			...
			onSearch : function (oEvent) {
				if (oEvent.getParameters().refreshButtonPressed) {
					...
					if (sQuery && sQuery.length > 0) {
						oTableSearchState = [new Filter("Aircrafttype", FilterOperator.Contains, sQuery)];
					}
